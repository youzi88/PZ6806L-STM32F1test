...
void EEPROM_Test(void)
{
	...
	AT24CXX_Init();
	FRONT_COLOR=YELLOW;
	LCD_ShowFont12Char(10,10,"EEPROM测试");
	LCD_ShowPicture(tftlcd_data.width-RETURN_X,tftlcd_data.height-RETURN_Y,RETURN_X,RETURN_Y,(u8 *)gImage_return);
	LCD_ShowFont12Char(10,44,"按K_UP键:对AT24C02写数据");
	LCD_ShowFont12Char(10,61,"按K_DOWM键:对AT24C02读数据");
	LCD_ShowFont12Char(10,100,"写数据的范围是: 0-255");
